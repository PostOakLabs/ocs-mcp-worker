...
// ---------------------------------------------------------------------------
// §18 — regenerate the ESM receipt wrapper the worker imports, from the canonical
// .json, so the two can never drift (idempotent).
// ---------------------------------------------------------------------------
const RECEIPT_JSON = resolve(ROOT, 'kernels', 'receipts', 'constraint-stacker.computeproof.json');
const RECEIPT_MJS  = resolve(ROOT, 'kernels', 'receipts', 'constraint-stacker.computeproof.mjs');
...
console.log('Regenerated §18 receipt wrapper: constraint-stacker.computeproof.mjs');
